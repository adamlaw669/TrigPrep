...
def play_sine():
    ...
    for i in range(x):
        ...
        ans = str(st.number_input('--->', key = 'sine_input'))
        st.write(ans, end= ' ')
        decimal_places = len(ans.split('.')[1]) if '.' in ans else 1
...
def play_tan():
    ...
    for i in range(x):
        ...
        ans = str(st.number_input('--->', key = 'tan_input'))
        st.write(ans, end= ' ')
        decimal_places = len(ans.split('.')[1]) if '.' in ans else 1
...
def play_cos():
    ...
    for i in range(x):
        ...
        ans = str(st.number_input('--->', 'cos_input'))
        st.write(ans, end= ' ')
        decimal_places = len(ans.split('.')[1]) if '.' in ans else 1
